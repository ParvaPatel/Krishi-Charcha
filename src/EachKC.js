...
const EachKC = (props) => {
    ...
    const likeTh = {threadId,userId};
        fetch('https://krishi-charcha.herokuapp.com/likeCheck', {
            method: 'POST',
    ...
    function likeOnClick(type) {
        ...
        if(type){
            fetch('https://krishi-charcha.herokuapp.com/likeAdd', {
                method: 'POST',
                headers: {"Content-Type": "application/json"},
                body: JSON.stringify(likeTh)
            }).then(res => {
            ...
            fetch('https://krishi-charcha.herokuapp.com/likeDel', {
                method: 'DELETE',
                headers: {"Content-Type": "application/json"},
                body: JSON.stringify(likeTh)
            }).then(res => {
    ...
    // const text = "A post about '"+ eachKCBLog.title + "' by "+ eachKCBLog.username + " from "+eachKCBLog.location + ". - ";
        ...
        <>
            { author && <>
                    ...
                    <div className="eachKB">
                        ...
                        <Link to={`/KrishiCharcha/${eachKCBLog._id}`}>
